...
\def \codeDOI{https://github.com/rescience-c/template}
\def \dataURL{test.com}
\def \dataDOI{https://github.com/rescience-c/template}
\def \editorNAME{}
\def \editorORCID{}
\def \reviewerINAME{}
\def \reviewerIORCID{}
\def \reviewerIINAME{}
\def \reviewerIIORCID{}
\def \dateRECEIVED{01 November 2022}
\def \dateACCEPTED{}
\def \datePUBLISHED{}
\def \articleTITLE{Voronoi stippling}
...
\def \replicationURL{}
\def \replicationDOI{}
\def \contactNAME{Ferdi Stoeltie}
\def \contactEMAIL{ferdi.stoeltie@student.hu.nl}
...
\def \articleNUMBER{}
\def \articleDOI{}
\def \authorsFULL{Ferdi Stoeltie}
\def \authorsABBRV{F. Stoeltie}
\def \authorsSHORT{Ferdi}
\title{\articleTITLE}
\date{}
\author[1,2,\orcid{0000}]{Ferdi Stoeltie}
